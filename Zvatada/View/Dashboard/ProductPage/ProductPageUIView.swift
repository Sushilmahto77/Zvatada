...
struct ProductPageUIView: View {
    ...
    var body: some View {
        ...
        // StarRatingUIView()
                                    ReviewPageUIView( ProductDetailsResponseModel: $ProductDetailsResponseModel, tempProductId: $productIdTemp, productIdTemp: $productIdTemp, ratings: $DataFound, barRate: 0)
                                }
...
//struct ProductPageUIView_Previews: PreviewProvider {
//    static var previews: some View {
//        ProductPageUIView(ProductDetailsResponseModel: <#ProductDetailsResponse#>, productIdTemp: <#Binding<String>#>)
//    }
//}
